...
static func reduce_particles(particle_system: GPUParticles2D, reduction_factor: float) -> void:
	...
	#
	# static func optimize_particle_system_for_mobile(particle_system: GPUParticles2D) -> void:Apply comprehensive mobile optimizations to a particle system
	...
	#
	# static func set_max_tweens(max_count: int) -> void:Set the maximum number of concurrent tweens allowed
	
	@param max_count: Maximum number of tweens (default: 20)
	# _max_tweens = max(1, max_count)
	#
	# static func create_managed_tween(scene_tree: SceneTree) -> Tween:Create a tween with automatic limiting
	...
	# return tween
	#
	# static func _cleanup_finished_tweens() -> void:Remove finished or invalid tweens from tracking
...
static func get_active_tween_count() -> int:
	...
	#
	# static func kill_all_tweens() -> void:Kill all tracked tweens immediately
	...
	# # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
	#
	# static func verify_texture_compression(texture: Texture2D) -> bool:Verify that a texture uses mobile-optimized compression
	...
	# return false
	#
	# static func optimize_textures_for_mobile(root: Node) -> Dictionary:Scan scene tree and report texture optimization status
	...
	# return stats
	#
	# static func _scan_textures_recursive(node: Node, stats: Dictionary) -> void:Recursively scan for textures in the scene tree
