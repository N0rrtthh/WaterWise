...
## Set the scale of the indicator relative to target.
## scale_factor: 1.3 = 30% larger than target
func set_indicator_scale(scale_factor: float) -> void:
...
## Get the visual size of the target node.
