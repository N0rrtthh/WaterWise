...
## ═══════════════════════════════════════════════════════════════════
## BODY DEFORMATION PROPERTY TEST (MINIMAL VERSION)
## ═══════════════════════════════════════════════════════════════════
...
# Mock character class for testing the deformation logic
class MockWaterDropletCharacter:
	...
	func apply_squash_stretch(squash: float, stretch: float) -> void:
		...
		# Same logic as WaterDropletCharacter.gd
...
func _ready() -> void:
	...
	print("\n" + "=".repeat(60))
	print("BODY DEFORMATION PROPERTY TEST (MINIMAL)")
...
func test_body_deformation_property():
	...
	var character = MockWaterDropletCharacter.new()
